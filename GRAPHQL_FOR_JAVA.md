- [What is GraphQL and why do people want it?](#org07c2290)
- [How do I provide the GraphQL that people want, especially as a Java developer?](#orgedf6127)
- [How exactly do I build a GraphQL API server in Java for a real application?](#orgdaf9608)
- [No, but really, how exactly do I build a GraphQL API server in Java for a real application?](#org45e7a13)
  - [Step 6:  Choose Docker Compose for orchestrating a development database server.](#org0ed55d7)
  - [Step 7:  Choose the Chinook data model.](#org2837fcd)
  - [Step 8:  Choose the Spring Initializr for bootstrapping the application.](#org25fce63)
  - [Step 9: Create a GraphQL schema file.](#orgd1788d6)
  - [Step 10:  Write Java model classes.](#org9d49153)
  - [Step 11-14:  Write Java controller classes.  Annotate every controller.  Annotate every resolver/data-fetcher.  Implement those resolver/data-fetcher.](#org193b278)
  - [Step 15:  Upgrade *some* of those resolver/data-fetcher methods with the data loader pattern.](#orgf4fe6a7)
    - [Editorial Aside!](#orga70999a)
- [Is this the *Only* way to build a GraphQL API server?<a id="org9ecd24c"></a>](#orgd2dfada)
- [How to choose "Buy" over "Buy"](#org550092f)
- [FAQ](#org761deed)
- [About Me](#org1f5fa96)
...
## Step 6:  Choose Docker Compose for orchestrating a development database server.
...
## Step 7:  Choose the Chinook data model.
...
## Step 8:  Choose the Spring Initializr for bootstrapping the application.

The important things with the [Spring Initializr](https://start.spring.io/) are to make these choices:
...
## Step 9: Create a GraphQL schema file.
...
3.  Every resolver method gets annotated with `@SchemaMapping`, `@QueryMapping`, or `@BatchMapping` (more on that [later](#orgf4fe6a7)).
...
8.  You *will* experience the urge to be clever, to create abstractions that dynamically respond to more and more complex combinations of parameters, filters, and other conditions. Congratulations: you're on your way to building a [general-purpose query engine](#org9ecd24c).
...
<div class="detail" id="orgaef8a64">
<p>
...
# Is this the *Only* way to build a GraphQL API server?<a id="org9ecd24c"></a>
